...
//            var tenant = s.GetRequiredService<IHttpContextAccessor>()?.HttpContext?.Request?.Host.Value ?? "";
            var tenant = s.GetService<IHttpContextAccessor>()?.HttpContext?.Request?.Host.Value ?? "";
        ...
        services.AddDataBind<int>(c =>
        {
            ...
            c.AddBatches<InMemoryBatchStorage, StorageProvider>()
             ...
             //Order
             .AddBatchItem<DbContextTypedPostBatchCommand<Order, OrderIn<int>, OrderIn<ValueReferenceT<int>>,int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPutBatchCommand<Order, OrderIn<int>, OrderIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPatchBatchCommand<Order, OrderIn<int>, OrderIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedDeleteBatchCommand<Order, int>>()
             //OrderDetail
             .AddBatchItem<DbContextTypedPostBatchCommand<OrderDetail, OrderDetailIn<int>, OrderDetailIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPutBatchCommand<OrderDetail, OrderDetailIn<int>, OrderDetailIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPatchBatchCommand<OrderDetail, OrderDetailIn<int>, OrderDetailIn<ValueReferenceT<int>>, int>>()
             ...
             //UserGroup
             .AddBatchItem<DbContextTypedPostBatchCommand<UserGroup, UserGroupIn<int>, UserGroupIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPutBatchCommand<UserGroup, UserGroupIn<int>, UserGroupIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPatchBatchCommand<UserGroup, UserGroupIn<int>, UserGroupIn<ValueReferenceT<int>>, int>>()
             ...
             //GroupPermission
             .AddBatchItem<DbContextTypedPostBatchCommand<GroupPermission, GroupPermissionIn<int>, GroupPermissionIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPutBatchCommand<GroupPermission, GroupPermissionIn<int>, GroupPermissionIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPatchBatchCommand<GroupPermission, GroupPermissionIn<int>, GroupPermissionIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedDeleteBatchCommand<GroupPermission, int>>()
             //UserPermission
             .AddBatchItem<DbContextTypedPostBatchCommand<UserPermission, UserPermissionIn<int>, UserPermissionIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPutBatchCommand<UserPermission, UserPermissionIn<int>, UserPermissionIn<ValueReferenceT<int>>, int>>()
             .AddBatchItem<ConcurrencyDbContextTypedPatchBatchCommand<UserPermission, UserPermissionIn<int>, UserPermissionIn<ValueReferenceT<int>>, int>>()
