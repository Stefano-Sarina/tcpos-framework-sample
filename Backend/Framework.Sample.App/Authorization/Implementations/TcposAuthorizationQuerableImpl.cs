...
public class TcposAuthorizationQuerableImpl<TPermissionValue>(IStorageProvider storageProvider) : ITcposAuthorizationQuerable<TPermissionValue, int>, IDisposable
