...
internal class AuthorizationManagerErpReplace(
    ...
    : AuthorizationManagerBaseErp<AuthorizationRequirementErpReplace>(ctxStore, userStore, permissionStore, permissionValueStore, groupStore);
