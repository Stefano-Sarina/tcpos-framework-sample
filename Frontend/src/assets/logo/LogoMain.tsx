...
import logoIcon from '../images/logo-tcposDaily.png';
import logoIconDark from '../images/logo-tcposDaily_dark1.png';
...
const LogoMain = ({ reverse, ...others }: { reverse?: boolean }) => {
  ...
  return (
     ...
     *
     */
      <img className="logo logo-image" src={theme.palette.mode === 'dark' ? logoIconDark : logoIcon} alt="TCPos" width="100" />
