...
namespace Framework.Sample.App.WebApplication.FormsEndpoints
{
    internal class PermissionNode
    {
        ...
        private int max_nested_entity_watchdog = 100;

        internal FePermission Permission { get; set; }
        ...
        internal bool HasAllParents() =>
            ParentNodes.ToEnumerableOrEmpty().Count() == Item.PermissionItemParents.ToEnumerableOrEmpty().Count();
        ...
        /// properly formatted.
        /// </summary>
        /// <param name="formsEndpoints">The FeIn object containing the form endpoints 
        /// and their associated permission items.</param>
        /// <returns>A list of <see cref="PermissionNode"/> objects representing 
