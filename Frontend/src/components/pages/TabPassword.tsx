...
/*
    ...
    minLength
*/
 from '../themeComponents/@extended/IconButton';
...
import {SnackBarCloseAction} from "@tcpos/backoffice-components";
        ...
        <MainCard title="Change Password">
            <Formik
                ...
                onSubmit={async (values, { resetForm, setErrors, setStatus, setSubmitting }) => {
                    try {
                        enqueueSnackbar(intl.formatMessage({id: "Password changed successfully"}), {
                            variant: "success",
                            persist: true,
