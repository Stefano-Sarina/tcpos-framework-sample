...
export const jsonConfigStructure: IJsonConfigStructure[] = [
    ...
    {
        propertyName: 'visibilityCondition',
        parentProperty: 'layoutGroups',
        type: 'object',
        optional: true,
        defaultAdd: false,
    ...
    },
    {
        ...
        parentProperty: 'visibilityCondition',
        type: 'leaf',
        optional: false,
        defaultAdd: true,
        unique: false,
    ...
    },
    {
        ...
        defaultAdd: true, 
        unique: false,
        defaultValue: 'nboStringTextField'
    },
    {
    ...
    },
    {
        ...
        parentProperty: 'components',
        conditionalProperty: "componentType",
        conditionalValueExclusion: ["nboButton"],
        type: 'leaf',
        optional: true,
        defaultAdd: true, 
        unique: false,
    ...
    },
    {
        ...
        parentProperty: 'components',
        conditionalProperty: "componentType",
        conditionalValue: ["nboNumberTextField"],
        type: 'leaf',
        optional: false,
        defaultAdd: true, 
        unique: false,
